...
public class Util {
    ...
    static void detectArchons(RobotController rc) throws GameActionException {
        ...
        for (RobotInfo enemyRobot : enemyRobots) {
            if (RobotType.ARCHON.equals(enemyRobot.getType())) {
                ...
                rc.broadcast(0, (int) enemyArchonLocation.x);
                rc.broadcast(1, (int) enemyArchonLocation.y);
            }
        }
    }
}
